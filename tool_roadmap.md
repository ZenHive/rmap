...
| 12d | **Audit follow-ups** | 🔄 | 12d.1 FOCUS render block ✅, 12d.2 `degenerate_bundle` lint ✅, 12d.4 `missing_acceptance_criteria` lint ✅. Remaining: 12d.3 optional `module` field on Task. |
...
Sequence by Eff: 12d.2 (2.25 🎯) ✅ → 12d.1 (2.0 🚀) ✅ → 12d.4 (2.0 🚀) ✅ → 12d.3 (1.67 🚀). 12d.2 + 12d.4 shipped together (bundle 1, commit 593d0ff). 12d.1 shipped as the first slice of bundle 2 — render-surface change (new FOCUS marker pair). Remaining in bundle 2: 12d.3 + 12b (`SKILLS.md`).
